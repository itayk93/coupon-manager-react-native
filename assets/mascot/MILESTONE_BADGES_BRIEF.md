...
`savings-10000` היה חזיר גנרי והוחלף בקופסת חיסכון בצללית של הדמות — בלי
פנים, בלי עיניים, בלי גפיים. זה חפץ בעולם שלו ולא וריאציה שלו, וזאת ההבחנה
ש-`docs/mascot/CHARACTER.md` §3 מותח: הסביבה והחפצים פתוחים, הדמות לא.
