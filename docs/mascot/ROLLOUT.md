...
| **סולם ההסלמה** ⚠️ | הסולם, הטיפוסים והחיווט נבנו ומכוסים בטסטים. ההסלמה עצמה נישאת בקצב הנגינה כי **אין ארט חדש** — ראה `STATE-LAW.md` §2 |
| **מעבר ההקלה** ❌ | לא בוצע. דורש 12 פריימים מצוירים של מודאג→מחייך, ואין מודל תמונה. גם דורש נגינה חד־פעמית ב־`MascotAnimation`, שלא נבנתה כי אין מה לנגן בה |
