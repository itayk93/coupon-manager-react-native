...
תיקון six-seven: קוסינוס יחיד יצר פריימי מראה זהים. השדה המעודכן משלב
גל אנכי אסימטרי עם הסטה אופקית קטנה בהפרש פאזה, כדי לתת לחזרה מסלול אחר.
36 פריימים, 24fps, תא 256px בשלב תיקון התנועה; הפנים והרגליים מעוגנים.
