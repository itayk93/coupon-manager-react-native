...
export const COUPON_COLUMNS = 'id,user_id,company,company_id,code,description,value,cost,used_value,status,expiration,date_added,is_available,is_one_time,is_for_sale,purpose,cvv,card_exp,buyme_coupon_url,strauss_coupon_url,xgiftcard_coupon_url,xtra_coupon_url,auto_download_details,auto_update,last_scraped,last_detail_view,last_company_view,last_code_view,reminder_sent_1_day,reminder_sent_7_days,reminder_sent_30_days,reminder_sent_today,show_in_widget,widget_display_order,special_message,discount_percentage,source' as const;
