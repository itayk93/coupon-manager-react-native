...
export function Kuponi({ state = "talking", reduceMotion, size = "medium", accessibilityLabel }: {
  state?: KuponiState;
  ...
  return <MascotAnimation state={state} reduceMotion={reduceMotion} size={points}
