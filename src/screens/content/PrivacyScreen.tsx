    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.background }]}>
      ...
      >
        ...
        >
          ...
          <Text style={[styles.sectionHeading, { color: theme.text }]}>
            5. מחיקת קופונים ושחזור
          </Text>
          <Text style={[styles.bodyText, { color: theme.textMuted }]}>
            כשמוחקים קופון הוא עובר לתיקיית "נמחקו לאחרונה" (בהגדרות) ולא נמחק מיד, כדי שאפשר יהיה לשחזר מחיקה בטעות. הקופון נשמר שם עד 30 יום ואז נמחק לצמיתות באופן אוטומטי. אפשר גם למחוק קופון לצמיתות באופן מיידי מאותו מסך. מחיקת החשבון מוחקת את כל הקופונים מיד, כולל אלה שבתיקיית "נמחקו לאחרונה".
          </Text>
        </View>
